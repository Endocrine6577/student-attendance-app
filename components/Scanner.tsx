...
interface ScannerProps {
  subjects: Subject[];
  students: Student[];
  onRecordAttendance: (studentId: number, subjectId: number, grade: number) => Student | null;
...
const Scanner: React.FC<ScannerProps> = ({ subjects, students, onRecordAttendance, showToast }) => {
  ...
  const handleScanSuccess = (decodedText: string) => {
    try {
      ...
      const student = onRecordAttendance(studentId, parseInt(selectedSubjectId), parseInt(selectedGrade));
